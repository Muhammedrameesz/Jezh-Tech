...
export const AnimatedTestimonials = ({ testimonials, autoplay = false }) => {
  ...
  return (
    <div className="bg-customWhite max-w-sm md:max-w-4xl mx-auto antialiased font-jost px-4 md:px-8 lg:px-12 py-20  shadow-[0px_5px_15px_rgba(0,0,0,0.35)] rounded-xl">
