...
export default function Service() {
  return (
    <div className=" font-jakarta py-10">
          ...
          <Anim delay={0.4}>
            <div className="bg-white h-[300px] hover:bg-customGreen rounded-lg border border-dashed border-green-200 hover:border-none font-jakarta group shadow-lg overflow-hidden hover:shadow-xl transform hover:-translate-y-2 transition-all duration-500">
              <div className="p-6">
                ...
                <p className="text-gray-500 text-sm font-semibold tracking-wide group-hover:text-gray-100 transition-all duration-500">
                  Simplify your life with smart home & industrial automation.
                  Control devices, enhance security, and boost efficiency with
                  intuitive solutions.
                </p>
              </div>
            </div>
          ...
          <Anim delay={0.6}>
            <div className="bg-white h-[300px] hover:bg-customGreen rounded-lg border border-dashed border-blue-200 hover:border-none font-jakarta group shadow-lg overflow-hidden hover:shadow-xl transform hover:-translate-y-2 transition-all duration-500">
              <div className="p-6 space-y-5">
                ...
                <h2 className="text-lg font-bold text-gray-800 group-hover:text-white  transition-all duration-500 ">
                  Website Development & Digital Presence
                </h2>

                <p className="text-gray-500 font-semibold text-sm group-hover:text-gray-100 tracking-wide transition-all duration-500">
                  Jezh Technologies crafts stunning websites that captivate
                  visitors, drive conversions, and deliver exceptional user
                  experiences.
                </p>
              </div>
            </div>
          ...
          <AnimRL delay={0.4}>
            <div className="bg-white h-[300px] hover:bg-customGreen rounded-lg border border-dashed border-rose-200 hover:border-none font-jakarta group shadow-lg overflow-hidden hover:shadow-xl transform hover:-translate-y-2 transition-all duration-500">
              <div className="p-6">
                ...
                <h2 className="text-lg font-bold text-gray-800 group-hover:text-white mb-5 transition-all duration-500 ">
                  Research & Development<span className="opacity-0">Welcome</span>
                </h2>

                <p className="text-gray-500 font-semibold tracking-wide text-sm group-hover:text-gray-100 transition-all duration-500">
                  We foster a culture of innovation through continuous research
                  and development, exploring cutting-edge technologies to
          ...
          <AnimRL delay={0.6}>
            <div className="bg-white h-[300px] hover:bg-customGreen rounded-lg border border-dashed border-lime-200 hover:border-none font-jakarta group shadow-lg overflow-hidden hover:shadow-xl transform hover:-translate-y-2 transition-all duration-500">
              <div className="p-6">
                ...
                <p className="text-gray-500 font-semibold text-sm tracking-wide  group-hover:text-gray-100 transition-all duration-500">
                  Empower your AI & Robotics future! We offer immersive programs
                  that equip you with the skills to thrive in these rapidly
                  evolving fields.
                </p>
              </div>
            </div>
