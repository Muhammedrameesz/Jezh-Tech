...
export default function SecSection() {
  ...
  return (
    <div className="w-full min-h-screen font-poppins mt-20 flex flex-col items-center bg-gray-50 py-10 pb-20 overflow-hidden">
      {/* Header Section */}
       ...
       <AnimRL>
        <div className={cardStyles(1)} onClick={() => handleCardClick(1)}>
          ...
          <p className="text-base text-gray-600 leading-relaxed ">
            ...
            designing and developing custom websites that are not only visually
            engaging but also optimized for user experience and functionality.
            We make sure your site is ready to engage and convert visitors
            seamlessly.
          </p>
          <button>
            <HoverButton>Know More</HoverButton>
